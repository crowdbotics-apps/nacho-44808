"""
Django settings for nacho_44808 project.
...
WSGI_APPLICATION = 'nacho_44808.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nacho_44808 API",
    "DESCRIPTION": "API documentation for nacho_44808 App",
    "VERSION": "v1",
}
